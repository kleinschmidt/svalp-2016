...
```{r lhood-fcn-update-animation, fig.retina=2, dev='png', fig.show='animate', cache=FALSE}
...
```{r class-fcn-update-animation, fig.retina=2, dev='png', fig.show='animate', cache=FALSE}
