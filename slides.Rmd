...
link:
  - "[&#64;kleinschmidt](http://twitter.com/kleinschmidt/)"
  - "[davekleinschmidt.com](http://davekleinschmidt.com/)"
output: 
...
# Variability <br /><span class="fragment">is a __problem__ for speech perception</span>
...
<div class="notes">
* Listeners rapidly adapt to unfamiliar talker
...
Simultaneously infer __what__ the talker is saying and __how__ they say things
...
## Ideal adapter predictions

> * Listeners' expectations about an unfamiliar talkers should be __as specific as possible__
> * Adaptation is constrained by __actual variability__ across talkers in the real world.
...
prior_p +
  geom_line(size = 2, alpha=0.5,
            data = all_priors %>% filter(as.numeric(source) == 3))
